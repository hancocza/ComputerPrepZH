...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { barcode: @computer.barcode, department: @computer.department, description: @computer.description, make: @computer.make, model: @computer.model, name: @computer.name } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { barcode: @computer.barcode, department: @computer.department, description: @computer.description, make: @computer.make, model: @computer.model, name: @computer.name } }
