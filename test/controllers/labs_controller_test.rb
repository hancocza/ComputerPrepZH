...
class LabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lab" do
    assert_difference('Lab.count') do
      post labs_url, params: { lab: { endDate: @lab.endDate, name: @lab.name, notes: @lab.notes, number: @lab.number, startDate: @lab.startDate } }
    end
  ...
  test "should update lab" do
    patch lab_url(@lab), params: { lab: { endDate: @lab.endDate, name: @lab.name, notes: @lab.notes, number: @lab.number, startDate: @lab.startDate } }
